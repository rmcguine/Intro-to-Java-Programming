package Exercises03.Exercise_03_13;

/**
 * (Financial application: compute taxes) Listing 3.5, ComputeTax.java, gives the source code to compute taxes for single filers. 
    ...
    public static void main(String[] args) {
        ...
        switch(status) {
            ...
            case 1: // Married jointly or qualifying widow(er)
                ...
                if (income > 67900)
                    tax += (income <= 13750) ? (income - 67900) * 0.25 : (137050 - 67900) * 0.25;
                if (income > 137050)
            ...
            case 3: // Head of household
                ...
                if (income > 372950)
                    tax += (income - 372950) * 0.35;
                break;
            default : System.out.println("Error: invalid statis");
            System.exit(1);    
