package Exercises03.Exercise_03_09;
...
the user to enter the first 9 digits and displays the 10-digit ISBN (including leading zeros). 
...
public class Exercise_03_09 {
    public static void main(String[] args) {
        ...
        // Find d10 via checksum forumla
        int d10 = (d1 * 1 + d2 * 2 + d3 * 3 + d4 * 4 + d5 * 5 +
            d6 * 6 + d7 * 7 + d8 * 8 + d9 * 9) % 11;
        
        // Display results
        System.out.print("The ISBN-10 number is " + d1 + d2 + d3 + d4 + d5 + d6 + d7 + d8 + 
            d9);
        if (d10 == 10)
